...
func get_subscription_response() -> String:
	...
	if mock_subscription_succeeds:
		return '{"result":"success","subscription":{"sku":"premium_monthly","displayName":"Premium Monthly","displayDescription":"Monthly premium subscription","status":"active","price":9.99,"currency":"USD","billingPeriod":"monthly","estimatedRevenue":6.69},"subscriptionSigned":"mock_jws"}'
	else:
		return '{"result":"cancel"}'
...
func get_subscriptions_response() -> String:
	...
	return '{"subscriptions":[{"sku":"premium","displayName":"Premium Subscription","displayDescription":"Unlock premium features and exclusive content.","status":"inactive","price":9.99,"currency":"USD","billingPeriod":"monthly","estimatedRevenue":6.69}],"signed":""}'
